...
function CheckLogined( )
{
	var userid = '';
	var password = '';
	userid = sessionStorage.key('userid');
	password = sessionStorage.key('password');
	
	if( userid == null || password == null)
	{
		location.href="../s2web/index.html"
	}
}

function SetCustomLogoTitle(SubTitle)
{
	var title = sessionStorage.getItem("dev_name") + " " + SubTitle;
	var logo_path = " <img src=\" " + sessionStorage.getItem("logo_path") + "\" alt=\"Logo\" >";  
	
	document.getElementById('logo_path').innerHTML = logo_path;

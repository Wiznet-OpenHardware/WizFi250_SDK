...
// sekim 20130703 system_monitors to non-static
//static wiced_system_monitor_t* system_monitors[MAXIMUM_NUMBER_OF_SYSTEM_MONITORS];
wiced_system_monitor_t* system_monitors[MAXIMUM_NUMBER_OF_SYSTEM_MONITORS];
...
// kaizen 20130412 ID1042
				...
				////////////////////////////////////////////////////////////////////////////////////
				// sekim 20130403 Add Task Monitor
				extern uint32_t wizfi_task_monitor_index;
				extern uint32_t wizfi_task_monitor_stop;
				if ( a==wizfi_task_monitor_index )
				{
					if ( wizfi_task_monitor_stop==1 )
					{
						////////////////////////////////////////////////////////////////////////////
						// sekim 20131023 ID1130 Reset-problem at AT+WJOIN
						extern wiced_system_monitor_t wizfi_task_monitor_item;
						#define MAXIMUM_ALLOWED_INTERVAL_BETWEEN_WIZFIMAINTASK (30000)

--------------------------------------------------------------------------------
WICED Webserver Resources Directory - README
--------------------------------------------------------------------------------
 
The Resources directory contains resources used by the WICED webserver.
...
Example Usage
  ...
  as the snip/ping_webserver or demo/temp_control apps provide suitable
  examples.
...
START_OF_HTTP_PAGE_DATABASE(ap_web_pages)
    ...
    { "/apps/apsta/ap_top.html",         "text/html",                WICED_STATIC_URL_CONTENT,  .url_content.static_data  = {resource_apps_DIR_apsta_DIR_ap_top_html, sizeof(resource_apps_DIR_apsta_DIR_ap_top_html) -1 }, },

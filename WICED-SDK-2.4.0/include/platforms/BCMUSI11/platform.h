...
// sekim 20130425 re-define GPIO(LED) according to USI11
//#define WICED_LED1       (WICED_GPIO_11)
//#define WICED_LED2       (WICED_GPIO_10)
#define WICED_LED1       (WICED_GPIO_12)
#define WICED_LED2       (WICED_GPIO_13)

//#define WICED_BUTTON1    (WICED_GPIO_29)	//MikeJ 130430 - MCU BOOT Button 29->2
...
#define WIZFI_SPI_REQ    (WICED_GPIO_14)
#define WIZFI_SPI_CS     (WICED_GPIO_27)
#define WIZFI_SPI_MISO   (WICED_GPIO_24)

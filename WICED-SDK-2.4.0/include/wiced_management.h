...
#if 1		// kaizen 2013507 - for 2.3.0 Migration
extern wiced_result_t wiced_configure_device_start(const configuration_entry_t* config, wiced_interface_t interface, wiced_network_config_t net_config, const wiced_ip_setting_t* ip_settings );
extern wiced_result_t wiced_configure_device_stop(void);
#endif

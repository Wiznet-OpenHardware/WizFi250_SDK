 ...
 * WICED SmartBridge API) and Apple MFi iAP.
 *
...
extern int start_iap                       ( int argc, char *argv[] );
...
static const command_t commands[] = {
    ...
    REBOOT_COMMANDS
    { (char*) "start_iap",                       start_iap,                       0, DELIMIT, NULL,  NULL ,                                                                     "Start iAP."},
    ...
    { (char*) "connect",                         connect,                         4, DELIMIT, NULL, (char*) "<socket_number> <device_address> <address_type> <enable_pairing>", "Establish a SmartBridge connection with a remote device."},

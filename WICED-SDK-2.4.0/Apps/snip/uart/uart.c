 ...
 *
 * NOTE
 *   WICED_UART_1 is assigned to standard I/O by default.
 *   To access WICED_UART_1 using the generic UART API,
...
void application_start( )
{
    ...
    while ( wiced_uart_receive_bytes( WICED_UART_1, &c, 1, WICED_NEVER_TIMEOUT ) == WICED_SUCCESS )
    {
